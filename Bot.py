...
# Define o caminho do browser para o Render
...
def tentar_agendar():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            log.info("Dias disponiveis: %d", len(dias_disponiveis))
            ...
            horarios = page.query_selector_all(".slot.available, input[type='radio']")
            if horarios:
                horarios[0].click()
                time.sleep(1)
